...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('althingi', '0024_auto_20171204_1745'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='speeches', to='althingi.Issue')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='speeches', to='althingi.Person')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='speeches', to='althingi.Session')),
            ],
            options={
