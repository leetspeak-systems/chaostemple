...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (b"document", "Parliamentary Documents"),
                            (b"review", "Reviews"),
                        ],
                        max_length=10,
                    ),
        ...
        migrations.AddField(
            ...
            name="issue",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="djalthingi.Issue"
            ),
        ),
        migrations.AddField(
            model_name="dossierstatistic",
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="dossier_statistics",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.AddField(
