...
urlpatterns = [
    ...
    re_path(r'^accounts/logout/$', auth_views.LogoutView.as_view(), {'next_page': settings.LOGIN_URL}),
    re_path(r'^register/$', CustomRegistrationView.as_view(), name='registration_register'),
    re_path(r'^custom-profile-data/$', custom_profile_data, name='custom_profile_data'),
    re_path(r'^activate/complete/$', terms_required(TemplateView.as_view(template_name='registration/activation_complete.html')), name='registration_activation_complete'),
