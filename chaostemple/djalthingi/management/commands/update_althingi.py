...
class Command(BaseCommand):
    ...
    def print_help(self):
        ...
        print("Commands:")
        print(
            "  upcoming                          Update upcoming committee agendas and parliamentary sessions"
        )
        print(
            "  issues                            Update issues in default or specified parliament"
        )
        print("  issue=<issue_num>                 Updates an issue by issue number")
        print(
            "  issue_statuses=                   Updates issue statuses in default or specified parliament"
        )
        print(
            "  issue_status=<issue_num>          Updates an issue status by issue number"
        )
        print(
            "  sessions                          Updates sessions in default or specified parliament"
        )
        print(
            "  session=<session_num>             Updates a particular session by session number"
        )
        print(
            "  persons                           Updates persons (MPs) in default or specified parliament"
        )
        print(
            "  person=<person_xml_id>            Updates person by XML ID (see Althingi's XML)"
        )
        print(
            "  ministers                         Updates ministerial positions in default or specified parliament"
        )
        print(
            "  presidents                        Updates presidential positions in default or specified parliament"
        )
        print(
            "  parties                           Updates parties in default or specified parliament"
        )
        print(
            "  committees                        Updates committees in default or specified parliament"
        )
        print(
            "  committee=<committee_xml_id>      Updates committee by XML ID (see Althingi's XML)"
        )
        print(
            "  committee_agendas                 Updates committee agendas in default or specified parliament"
        )
        print(
        ...
        print(
            "  vote_castings                     Updates vote castings in default or specified parliament"
        )
        print(
            "  speeches                          Updates speeches in default or specified parliament"
        )
        print(
        ...
        print(
            "                                    Must be integer or range of integers, for example 130-140"
        )
        print(
            "  days=<day-count>                  Only get info from the last given days in supported commands"
        )
        print(
            "                                    Supported commands: vote_castings, speeches"
        )
        print()
            ...
            if "parliament" in processed_args:
                ...
                try:
                    ...
                    if "-" in processed_args["parliament"]:
                        ...
                        parliament_from = parliament_to = int(
                            processed_args["parliament"]
                        )
