    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="committee_agendas",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="committee_agenda_items",
                        to="djalthingi.CommitteeAgenda",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("nefndarma\xf0ur", "nefndarma\xf0ur"),
                            ("varama\xf0ur", "varama\xf0ur"),
                            ("kj\xf6rinn varama\xf0ur", "kj\xf6rinn varama\xf0ur"),
                            ("forma\xf0ur", "forma\xf0ur"),
                            ("1. varaforma\xf0ur", "1. varaforma\xf0ur"),
                            ("2. varaforma\xf0ur", "2. varaforma\xf0ur"),
                            ("\xe1heyrnarfulltr\xfai", "\xe1heyrnarfulltr\xfai"),
                        ],
                        max_length=20,
                    ),
                ),
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                ...
                                "fyrirspurn til skriflegs svars",
                            ),
                            ...
                            (
                                "sk\xfdrsla n. (frumskjal)",
                                "sk\xfdrsla nefndar (frumskjal)",
                            ),
                            (
                            ...
                            (
                                "\xfe\xe1l. \xed heild",
                                "\xfeings\xe1lyktunartillaga \xed heild",
                            ),
                            ("\xfe\xe1ltill.", "\xfeings\xe1lyktunartillaga"),
                            (
                                "\xfe\xe1ltill. n.",
                                "\xfeings\xe1lyktunartillaga nefndar",
                            ),
                        ],
                        max_length=50,
                    ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (b"l", b"lagafrumvarp"),
                            (b"a", b"\xc3\xbeings\xc3\xa1lyktunartillaga"),
                            (b"m", b"fyrirspurn"),
                            (b"q", b"fyrirspurn til skriflegs svars"),
                            (b"s", b"sk\xc3\xbdrsla"),
                            (b"b", b"bei\xc3\xb0ni um sk\xc3\xbdrslu"),
                        ],
                        max_length=1,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                b"A",
                                b"\xc3\xbeingm\xc3\xa1l me\xc3\xb0 \xc3\xbeingskj\xc3\xb6lum",
                            ),
                            (
                                b"B",
                                b"\xc3\xbeingm\xc3\xa1l \xc3\xa1n \xc3\xbeingskjala",
                            ),
                        ],
                        default=b"A",
                        max_length=1,
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="parties", to="djalthingi.Parliament"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="subproposers",
                        to="djalthingi.Proposer",
                    ),
                ),
                (
                    "person",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ("as", "\xe1skorun"),
                            ("at", "athugasemd"),
                            ("\xe1u", "\xe1bending til umfj\xf6llunar"),
                            ("be", "bei\xf0ni"),
                            ("bk", "b\xf3kun"),
                            ("fr", "frestun \xe1 ums\xf6gn"),
                            ("fs", "fyrirspurn"),
                            ("ft", "fr\xe9ttatilkynning"),
                            ("fu", "fundarger\xf0"),
                            ("gg", "greinarger\xf0"),
                            ("it", "\xedtrekun"),
                            ("ka", "kostna\xf0ar\xe1\xe6tlun"),
                            ("lf", "lagt fram \xe1 fundi"),
                            ("lr", "lei\xf0r\xe9tting"),
                            ("mb", "minnisbla\xf0"),
                            ("mm", "m\xf3tm\xe6li"),
                            ("mt", "mat"),
                            ("na", "nefndar\xe1lit"),
                            ("sa", "sam\xfeykkt"),
                            ("se", "stu\xf0ningserindi"),
                            ("sk", "sk\xfdrsla"),
                            ("su", "sk\xfdrsla til umfj\xf6llunar"),
                            ("tk", "tilkynning"),
                            ("tl", "tillaga"),
                            ("tm", "tilm\xe6li"),
                            ("ub", "ums\xf6gn"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("\xfeingma\xf0ur", "\xfeingma\xf0ur"),
                            ("varama\xf0ur", "varama\xf0ur"),
                            ("me\xf0 varamann", "me\xf0 varamann"),
                        ],
                        max_length=20,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (b"2", "2. umr\xe6\xf0a"),
                            (b"3", "3. umr\xe6\xf0a"),
                            (b"E", "ein umr\xe6\xf0a"),
                            (b"F", "fyrri umr\xe6\xf0a"),
                            (b"S", "s\xed\xf0ari umr\xe6\xf0a"),
                        ],
                        max_length=1,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="session_agenda_items",
                        to="djalthingi.Issue",
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="djalthingi.Parliament"
            ),
        ),
        migrations.AddField(
            model_name="issue",
            ...
            field=models.ManyToManyField(
                related_name="future_issues", to="djalthingi.Issue"
            ),
        ),
        migrations.AddField(
            model_name="document",
        ...
        migrations.AddField(
            ...
            name="parliaments",
            field=models.ManyToManyField(
                related_name="constituencies", to="djalthingi.Parliament"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="parliaments",
            field=models.ManyToManyField(
                related_name="committees", to="djalthingi.Parliament"
            ),
        ),
    ]
