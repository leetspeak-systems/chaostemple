...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        ("djalthingi", "0003_auto_20161015_1815"),
        ...
        ("djalthingi", "0008_auto_20161212_0130"),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "frhnál. með rökst.",
                                "framhaldsnefndarálit með rökstuðningi",
                            ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    (b"s", b"sk\xc3\xbdrsla"),
                    (b"b", b"bei\xc3\xb0ni um sk\xc3\xbdrslu"),
                    (b"f", b"frestun \xc3\xa1 fundum Al\xc3\xbeingis"),
                    (b"n", b"\xc3\xa1lit"),
                    (b"v", b"vantrauststillaga"),
                ],
                max_length=1,
            ),
        ),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("committee-1-reviews-requested", "Reviews requested"),
                    ("committee-1-reviews-arrived", "Reviews deadline expired"),
                    ...
                    ("committee-former-reviews-requested", "Reviews requested"),
                    ("committee-former-reviews-arrived", "Reviews deadline expired"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "parliaments",
                    models.ManyToManyField(
                        related_name="ministers", to="djalthingi.Parliament"
                    ),
                ),
            ],
            options={
